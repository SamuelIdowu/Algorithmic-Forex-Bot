...
class ChiefInvestmentOfficer(BaseAgent):
    ...
    def _deliberate(self, symbol: str, context: dict) -> dict:
        ...
        prompt = (
            ...
            f"QUANT REPORT (ML & Technicals):\n{q_reason}\n\n"
            f"SENTIMENT REPORT (News & Headlines):\n{s_reason}\n\n"
            ...
            f"\"memo\": \"<2-3 sentences of actionable expert advice. Identify any contradictions, key entry/exit zones, or macro factors to watch.>\"}}"
        )
